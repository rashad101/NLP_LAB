...
class LCQuADSeq2SeqEmbTripleSamples(object):
    ...
    def save(self, dir_path, embed_type):
        np.save(dir_path + '/seq2seq_model-target-word2idx.npy', self.target_word2idx)
        np.save(dir_path + '/seq2seq_model-target-idx2word.npy', self.target_idx2word)
        ...
        print(config)
        np.save(dir_path + '/seq2seq_model-config.npy', config)
